...
const Json = {
  ...
  traverseJSON(storage, nodeName, fromAJAX) {
    let ctc;
    if ($(`${__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.b} textarea`).val() !== '' || localStorage.getItem('pgb_SavedNode') !== '' && fromAJAX === undefined) {
      if (storage === false) {
        ctc = $(`${__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.b} textarea`).val();
        if (ctc === '') {
      ...
      let obj = prs.hero;
      let len = obj.length;
      let formItems = $(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.cl).length;
      let formArray = [];
      if (formItems < len) {
        let build = true,
  ...
  outputJson(aCode, meth, name, mode) {
    try {
      ...
      if (meth === 'full') {
        if ($(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.he).css('display') === 'block') {
          $(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.he).css('display', 'none');
        }
        if ($(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.h).css('display') === 'block') {
          $(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.h).css('display', 'none');
        }
        if ($(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.ls).css('display') === 'block') {
          $(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.ls).css('display', 'none');
        }
        $(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.o).attr(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].handlers.r, 'output');
        $(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.o).css('display', 'block');
        $(`${__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.o} textarea`).val(page_model);
        $(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.r).animate({scrollTop: 0}, __WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].animation.d.min).css('overflow', 'hidden');
        if (mode === 'hero') {
          core.errorHandler();
        }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__assets_js_validate_json__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__assets_js_validate_json___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__assets_js_validate_json__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Config__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_Json__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_Storage__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_Validators__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_Items__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_Init__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_Version__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_Language__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_Errors__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_Preview__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_Utilities__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__components_EventHandlers__ = __webpack_require__(4);
/**
 * Created by David Maser on 09/06/2017.
 */
...
let pfHero = 0;
let pfMode = __WEBPACK_IMPORTED_MODULE_1__components_Config__["a" /* app */].params.s;
let pfExport = 'hero';
let sPos = 0;
let pfLang = __WEBPACK_IMPORTED_MODULE_1__components_Config__["a" /* app */].lang;

$(() => {
  /**
   * Main document ready initialized function
   */
  __WEBPACK_IMPORTED_MODULE_6__components_Init__["a" /* Init */].setHeadSec();
  __WEBPACK_IMPORTED_MODULE_6__components_Init__["a" /* Init */].initializeTheme();
  __WEBPACK_IMPORTED_MODULE_6__components_Init__["a" /* Init */].initHelp();
  __WEBPACK_IMPORTED_MODULE_7__components_Version__["a" /* Version */].getVersion(true);
  __WEBPACK_IMPORTED_MODULE_6__components_Init__["a" /* Init */].loadAPIparams();
  __WEBPACK_IMPORTED_MODULE_8__components_Language__["a" /* Language */].languageManager(__WEBPACK_IMPORTED_MODULE_1__components_Config__["a" /* app */].lang, true);
  window.setInterval(() => {
    __WEBPACK_IMPORTED_MODULE_7__components_Version__["a" /* Version */].getVersion(false);
  }, 600000);
  $('.date_obj').datetimepicker({format: 'MM/DD/YYYY HH:mm'});
